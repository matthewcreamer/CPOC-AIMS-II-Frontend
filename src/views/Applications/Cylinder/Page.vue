...
//Structures
import ViewFR from "@/views/Applications/Cylinder/View.vue"
import AddFR from "@/views/Applications/Cylinder/Add.vue"
import EditFR from "@/views/Applications/Cylinder/Edit.vue"

export default {
  name: "Cylinder-Report",
  components: {
    ViewFR,
    AddFR,
    EditFR

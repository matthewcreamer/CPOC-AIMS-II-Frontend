    ...
    <div class="pm-page-container">
      <div class="page-container">
        <DxDataGrid
          ...
          @row-inserted="CREATE_INSU"
          @row-updated="UPDATE_INSU"
          @row-removed="DELETE_INSU"
        ...
        >
          <DxEditing
            ...
            mode="row"
          />
          <DxColumn data-field="code" caption="Insulation">
            <DxRequiredRule />
          </DxColumn>

    ...
    <div class="pm-page-container">
      <div class="page-container">
        <DxDataGrid
          ...
          @row-inserted="CREATE_PREFIX"
          @row-updated="UPDATE_PREFIX"
          @row-removed="DELETE_PREFIX"
        ...
        >
          <DxEditing
            ...
            mode="row"
          />
          <DxColumn data-field="prefix_desc" caption="Prefix">
            <DxRequiredRule />
          </DxColumn>

    ...
    <div class="pm-page-container">
      <div class="page-container">
        <DxDataGrid
          ...
          @row-inserted="CREATE_CODE"
          @row-updated="UPDATE_CODE"
          @row-removed="DELETE_CODE"
        ...
        >
          <DxEditing
            ...
            mode="row"
          />
          <DxColumn data-field="code" caption="Construction Code">
            <DxRequiredRule />
          </DxColumn>
...
export default {
  ...
  methods: {
    ...
    UPDATE_CODE(e) {
      ...
      axios({
        method: "put",
        url: "/MdConstructionCode/" + e.data.id,
        headers: {
          Authorization: "Bearer " + JSON.parse(localStorage.getItem("token")),
        },
        data: e.data,

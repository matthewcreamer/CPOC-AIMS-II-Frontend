<template>
  <div class="pm-page">
    <div class="pm-toolbar">
      <toolbar
        pageName="Tank Internal Pressure"
    ...
    <div class="pm-page-container">
      <div class="page-container">
        <DxDataGrid
          ...
          @row-inserted="CREATE_PRESSURE"
          @row-updated="UPDATE_PRESSURE"
          @row-removed="DELETE_PRESSURE"
        ...
        >
          <DxEditing
            ...
            mode="row"
          />
          <DxColumn data-field="code" caption="Tank Internal Pressure">
            <DxRequiredRule />
          </DxColumn>
...
export default {
  ...
  methods: {
    ...
    UPDATE_PRESSURE(e) {
      ...
      axios({
        method: "put",
        url: "/MdTankInternalPressure/" + e.data.id,
        headers: {
          Authorization: "Bearer " + JSON.parse(localStorage.getItem("token")),
        },
        data: e.data,

    ...
    <div class="page-section">
      <div class="table-wrapper">
        ...
        <div class="input-wrapper" fill>
          ...
          <div class="input">
            <DxTextBox
              value="Filter Coalescing Crack Detection"
            />
          </div>
        </div>

        <div fill class="html-editor">
            <DxHtmlEditor @valueChanged="updateOutput($event)" height="430" :value="editorValue">
        ...
        <button class="create" @click="$emit('currentView', 0)">Edit</button>
...
export default {
  ...
  methods: {
    updateOutput(e) {
      this.editorValue = e.component.option("value");
      console.log("updateOutput", this.editorValue);
    },
    EXPORT_DATA(e) {
